...
object Collections {
  ...
  /** Simple binary search that finds the closest element (relative to the head of a Sequence) that satisfies a boundary
    * condition
    * @param elems
    *   the sorted sequence to search
    * @param boundary
    *   boundary value
    * @param candidate
    *   the last element we have found that satisfies the boundary condition
    * @param compare
    *   a function that will compare each element in elems to the boundary
    * @return
