...
lazy val api = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "io.flow" %% "lib-play-play26" % "0.5.70",
      "io.flow" %% "lib-play-graphite-play26" % "0.1.1",
      "io.flow" %% "lib-reference-scala" % "0.2.31",
      "io.flow" %% "lib-s3-play26" % "0.2.68",
      "com.google.maps" % "google-maps-services" % "0.9.1",
      "org.scalacheck" %% "scalacheck" % "1.14.0" % "test",
      "io.flow" %% "lib-test-utils" % "0.0.57" % Test,
      "io.flow" %% "lib-usage" % "0.0.98",
      "io.flow" %% "lib-log" % "0.0.77"
    ),
