 ...
 * User agent: apibuilder app.apibuilder.io/flow/google-places/latest/play_2_8_client
 */
  ...
  package object json {
    ...
    implicit def jsonWritesGooglePlacesAddressComponentType: play.api.libs.json.Writes[AddressComponentType] = {
      (obj: io.flow.google.places.v0.models.AddressComponentType) => {
        io.flow.google.places.v0.models.json.jsonWritesGooglePlacesAddressComponentType(obj)
      }
    }
  }
}
...
package io.flow.google.places.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/google-places/latest/play_2_8_client"
    val Version = "0.3.46"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.google.places.v0.Client")
