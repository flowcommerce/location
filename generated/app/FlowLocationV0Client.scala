 ...
 * Service version: 0.0.50
 * apidoc:0.11.32 http://www.apidoc.me/flow/location/0.0.50/play_2_4_client
 */
...
package io.flow.location.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.32 http://www.apidoc.me/flow/location/0.0.50/play_2_4_client"
    val Version = "0.0.50"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Locations extends Locations {
      override def get(
      ...
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[io.flow.common.v0.models.Location]] = {
        ...
        _executeRequest("GET", s"/locations", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.location.v0.Client.parseJson("Seq[io.flow.common.v0.models.Location]", r, _.validate[Seq[io.flow.common.v0.models.Location]])
