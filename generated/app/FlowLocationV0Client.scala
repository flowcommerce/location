 ...
 * Service version: 0.17.20
 * apibuilder 0.15.33 app.apibuilder.io/flow/location/latest/play_2_8_client
 */
  ...
  package object json {
    ...
    implicit def jsonWritesLocationLocationErrorCode: play.api.libs.json.Writes[LocationErrorCode] = {
      (obj: io.flow.location.v0.models.LocationErrorCode) => {
        jsonWritesLocationLocationErrorCode(obj)
      }
    }
    ...
    implicit def jsonReadsLocationLocationError: play.api.libs.json.Reads[LocationError] = {
      for {
...
package io.flow.location.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/flow/location/latest/play_2_8_client"
    val Version = "0.17.20"
    val VersionMajor = 0
