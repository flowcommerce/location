 ...
 * apibuilder 0.14.93 app.apibuilder.io/flow/location/latest/play_2_8_client
 */
...
package io.flow.location.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/location/latest/play_2_8_client"
    val Version = "0.8.35"
    val VersionMajor = 0
