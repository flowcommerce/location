 ...
 * apibuilder:0.12.20 https://app.apibuilder.io/flow/location/0.3.47/play_2_4_client
 */
package io.flow.location.v0.models {
   ...
   * @param suggestions Where available, we return a list of suggestions for verified
   * addresses. Each suggestion contains both the suggested address as well as the
   * specific fields that are different
   */
   ...
   * @param currency The default currency for this country as a ISO 4217 3 currency
   * code as defined in https://api.flow.io/reference/currencies
   * @param language The default language for this country as a ISO 639 2 language
   * code as defined in https://api.flow.io/reference/languages
   */
...
package io.flow.location.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.20 https://app.apibuilder.io/flow/location/0.3.47/play_2_4_client"
    val Version = "0.3.47"
    val VersionMajor = 0
    ...
    object Addresses extends Addresses {
      override def get(
        ...
        _executeRequest("GET", s"/addresses", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 422 => throw new io.flow.location.v0.errors.GenericErrorResponse(r)
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw new io.flow.location.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
  ...
  trait CountryDefaults {
    /**
     * @param country The ISO 3166 2 or 3 character code for the country. Case
     * insensitive. See https://api.flow.io/reference/countries
     * @param address
     * @param ip
     */
    def get(
