 ...
 * Service version: 0.9.43
 * apibuilder 0.15.9 app.apibuilder.io/flow/location/latest/play_2_8_client
 */
package io.flow.location.v0.models {
  ...
  object LocationErrorCode {
     ...
     * Address
     */
    case object TimezoneUnavailable extends LocationErrorCode { override def toString = "timezone_unavailable" }
...
package io.flow.location.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsLocationLocationErrorCode = new play.api.libs.json.Reads[io.flow.location.v0.models.LocationErrorCode] {
    ...
    implicit def jsonWritesLocationLocationErrorCode: play.api.libs.json.Writes[LocationErrorCode] = {
      new play.api.libs.json.Writes[io.flow.location.v0.models.LocationErrorCode] {
        def writes(obj: io.flow.location.v0.models.LocationErrorCode) = {
    ...
    implicit def jsonWritesLocationLocationError: play.api.libs.json.Writes[LocationError] = {
      new play.api.libs.json.Writes[io.flow.location.v0.models.LocationError] {
        def writes(obj: io.flow.location.v0.models.LocationError) = {
...
package io.flow.location.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.9 app.apibuilder.io/flow/location/latest/play_2_8_client"
    val Version = "0.9.43"
    val VersionMajor = 0
