 ...
 * apidoc:0.11.24 http://www.apidoc.me/flow/location/0.0.12/play_2_4_client
 */
...
package io.flow.location.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsLocationLocation: play.api.libs.json.Reads[Location] = {
      (
    ...
    def jsObjectLocation(obj: io.flow.location.v0.models.Location) = {
    ...
    implicit def jsonWritesLocationLocation: play.api.libs.json.Writes[Location] = {
      new play.api.libs.json.Writes[io.flow.location.v0.models.Location] {
        def writes(obj: io.flow.location.v0.models.Location) = {
...
package io.flow.location.v0 {
  ...
  package interfaces {
    ...
    trait Client {
      def baseUrl: String
      def locations: io.flow.location.v0.Locations
    }
  ...
  package errors {
    ...
    case class ErrorsResponse(
      ...
      lazy val errors = _root_.io.flow.location.v0.Client.parseJson("Seq[io.flow.common.v0.models.Error]", response, _.validate[Seq[io.flow.common.v0.models.Error]])
    }
