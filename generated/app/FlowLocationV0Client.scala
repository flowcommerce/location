 ...
 * apidoc:0.11.37 http://www.apidoc.me/flow/location/0.1.72/play_2_4_client
 */
...
package io.flow.location.v0.models {
  ...
  package object json {
    ...
    def jsObjectAddressSuggestion(obj: io.flow.location.v0.models.AddressSuggestion) = {
    ...
    def jsObjectAddressVerification(obj: io.flow.location.v0.models.AddressVerification) = {
      play.api.libs.json.Json.obj(
        "address" -> io.flow.common.v0.models.json.jsObjectAddress(obj.address),
    ...
    def jsObjectCountryDefaults(obj: io.flow.location.v0.models.CountryDefaults) = {
      play.api.libs.json.Json.obj(
...
package io.flow.location.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.37 http://www.apidoc.me/flow/location/0.1.72/play_2_4_client"
    val Version = "0.1.72"
    val VersionMajor = 0
    ...
    object Addresses extends Addresses {
      override def get(
        ...
        _executeRequest("GET", s"/addresses", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 422 => throw new io.flow.location.v0.errors.ValidationErrorResponse(r)
  ...
  package errors {
    ...
    case class ValidationErrorResponse(
      ...
      lazy val validationError = _root_.io.flow.location.v0.Client.parseJson("io.flow.error.v0.models.ValidationError", response, _.validate[io.flow.error.v0.models.ValidationError])
    }
