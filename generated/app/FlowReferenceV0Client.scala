 ...
 * User agent: apibuilder app.apibuilder.io/flow/reference/latest/play_2_8_client
 */
  ...
  package object json {
    ...
    implicit def jsonWritesReferencePaymentMethodCapability: play.api.libs.json.Writes[PaymentMethodCapability] = {
      (obj: io.flow.reference.v0.models.PaymentMethodCapability) => {
        io.flow.reference.v0.models.json.jsonWritesReferencePaymentMethodCapability(obj)
      }
    }
    ...
    implicit def jsonWritesReferencePaymentMethodType: play.api.libs.json.Writes[PaymentMethodType] = {
      (obj: io.flow.reference.v0.models.PaymentMethodType) => {
        io.flow.reference.v0.models.json.jsonWritesReferencePaymentMethodType(obj)
      }
    }
    ...
    implicit def jsonWritesReferencePostalType: play.api.libs.json.Writes[PostalType] = {
      (obj: io.flow.reference.v0.models.PostalType) => {
        io.flow.reference.v0.models.json.jsonWritesReferencePostalType(obj)
      }
    }
    ...
    implicit def jsonWritesReferenceProvinceType: play.api.libs.json.Writes[ProvinceType] = {
      (obj: io.flow.reference.v0.models.ProvinceType) => {
        io.flow.reference.v0.models.json.jsonWritesReferenceProvinceType(obj)
      }
    }

    implicit def jsonReadsReferenceCarrier: play.api.libs.json.Reads[io.flow.reference.v0.models.Carrier] = {
      for {
    ...
    implicit def jsonWritesReferenceCarrier: play.api.libs.json.Writes[Carrier] = {
      (obj: io.flow.reference.v0.models.Carrier) => {
        io.flow.reference.v0.models.json.jsObjectCarrier(obj)
      }
    }

    implicit def jsonReadsReferenceCarrierService: play.api.libs.json.Reads[io.flow.reference.v0.models.CarrierService] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    def jsObjectCarrierService(obj: io.flow.reference.v0.models.CarrierService): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "carrier" -> io.flow.reference.v0.models.json.jsObjectCarrier(obj.carrier),
        "name" -> play.api.libs.json.JsString(obj.name)
      )
    }
    ...
    implicit def jsonWritesReferenceCarrierService: play.api.libs.json.Writes[CarrierService] = {
      (obj: io.flow.reference.v0.models.CarrierService) => {
        io.flow.reference.v0.models.json.jsObjectCarrierService(obj)
      }
    }

    implicit def jsonReadsReferenceCountry: play.api.libs.json.Reads[io.flow.reference.v0.models.Country] = {
      for {
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesReferenceCountry: play.api.libs.json.Writes[Country] = {
      (obj: io.flow.reference.v0.models.Country) => {
        io.flow.reference.v0.models.json.jsObjectCountry(obj)
      }
    }

    implicit def jsonReadsReferenceCurrency: play.api.libs.json.Reads[io.flow.reference.v0.models.Currency] = {
      for {
        name <- (__ \ "name").read[String]
    ...
    def jsObjectCurrency(obj: io.flow.reference.v0.models.Currency): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("symbols" -> io.flow.reference.v0.models.json.jsObjectCurrencySymbols(x))
      }) ++
    ...
    implicit def jsonWritesReferenceCurrency: play.api.libs.json.Writes[Currency] = {
      (obj: io.flow.reference.v0.models.Currency) => {
        io.flow.reference.v0.models.json.jsObjectCurrency(obj)
      }
    }

    implicit def jsonReadsReferenceCurrencySymbols: play.api.libs.json.Reads[io.flow.reference.v0.models.CurrencySymbols] = {
      for {
    ...
    implicit def jsonWritesReferenceCurrencySymbols: play.api.libs.json.Writes[CurrencySymbols] = {
      (obj: io.flow.reference.v0.models.CurrencySymbols) => {
        io.flow.reference.v0.models.json.jsObjectCurrencySymbols(obj)
      }
    }

    implicit def jsonReadsReferenceLanguage: play.api.libs.json.Reads[io.flow.reference.v0.models.Language] = {
      for {
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesReferenceLanguage: play.api.libs.json.Writes[Language] = {
      (obj: io.flow.reference.v0.models.Language) => {
        io.flow.reference.v0.models.json.jsObjectLanguage(obj)
      }
    }

    implicit def jsonReadsReferenceLocale: play.api.libs.json.Reads[io.flow.reference.v0.models.Locale] = {
      for {
        id <- (__ \ "id").read[String]
        name <- (__ \ "name").read[String]
    ...
    def jsObjectLocale(obj: io.flow.reference.v0.models.Locale): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "numbers" -> io.flow.reference.v0.models.json.jsObjectLocaleNumbers(obj.numbers)
      )
    }

    implicit def jsonWritesReferenceLocale: play.api.libs.json.Writes[Locale] = {
      (obj: io.flow.reference.v0.models.Locale) => {
        io.flow.reference.v0.models.json.jsObjectLocale(obj)
      }
    }

    implicit def jsonReadsReferenceLocaleNumbers: play.api.libs.json.Reads[io.flow.reference.v0.models.LocaleNumbers] = {
      for {
    ...
    implicit def jsonWritesReferenceLocaleNumbers: play.api.libs.json.Writes[LocaleNumbers] = {
      (obj: io.flow.reference.v0.models.LocaleNumbers) => {
        io.flow.reference.v0.models.json.jsObjectLocaleNumbers(obj)
      }
    }

    implicit def jsonReadsReferenceLocalizedTranslation: play.api.libs.json.Reads[io.flow.reference.v0.models.LocalizedTranslation] = {
      for {
    ...
    implicit def jsonWritesReferenceLocalizedTranslation: play.api.libs.json.Writes[LocalizedTranslation] = {
      (obj: io.flow.reference.v0.models.LocalizedTranslation) => {
        io.flow.reference.v0.models.json.jsObjectLocalizedTranslation(obj)
      }
    }

    implicit def jsonReadsReferencePaymentMethod: play.api.libs.json.Reads[io.flow.reference.v0.models.PaymentMethod] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    def jsObjectPaymentMethod(obj: io.flow.reference.v0.models.PaymentMethod): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "name" -> play.api.libs.json.JsString(obj.name),
        "images" -> io.flow.reference.v0.models.json.jsObjectPaymentMethodImages(obj.images),
    ...
    implicit def jsonWritesReferencePaymentMethod: play.api.libs.json.Writes[PaymentMethod] = {
      (obj: io.flow.reference.v0.models.PaymentMethod) => {
        io.flow.reference.v0.models.json.jsObjectPaymentMethod(obj)
      }
    }

    implicit def jsonReadsReferencePaymentMethodImage: play.api.libs.json.Reads[io.flow.reference.v0.models.PaymentMethodImage] = {
      for {
    ...
    implicit def jsonWritesReferencePaymentMethodImage: play.api.libs.json.Writes[PaymentMethodImage] = {
      (obj: io.flow.reference.v0.models.PaymentMethodImage) => {
        io.flow.reference.v0.models.json.jsObjectPaymentMethodImage(obj)
      }
    }

    implicit def jsonReadsReferencePaymentMethodImages: play.api.libs.json.Reads[io.flow.reference.v0.models.PaymentMethodImages] = {
      for {
    ...
    def jsObjectPaymentMethodImages(obj: io.flow.reference.v0.models.PaymentMethodImages): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "small" -> io.flow.reference.v0.models.json.jsObjectPaymentMethodImage(obj.small),
        "medium" -> io.flow.reference.v0.models.json.jsObjectPaymentMethodImage(obj.medium),
        "large" -> io.flow.reference.v0.models.json.jsObjectPaymentMethodImage(obj.large)
      )
    }
    ...
    implicit def jsonWritesReferencePaymentMethodImages: play.api.libs.json.Writes[PaymentMethodImages] = {
      (obj: io.flow.reference.v0.models.PaymentMethodImages) => {
        io.flow.reference.v0.models.json.jsObjectPaymentMethodImages(obj)
      }
    }

    implicit def jsonReadsReferenceProvince: play.api.libs.json.Reads[io.flow.reference.v0.models.Province] = {
      for {
        id <- (__ \ "id").read[String]
        iso31662 <- (__ \ "iso_3166_2").read[String]
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesReferenceProvince: play.api.libs.json.Writes[Province] = {
      (obj: io.flow.reference.v0.models.Province) => {
        io.flow.reference.v0.models.json.jsObjectProvince(obj)
      }
    }

    implicit def jsonReadsReferenceRegion: play.api.libs.json.Reads[io.flow.reference.v0.models.Region] = {
      for {
        id <- (__ \ "id").read[String]
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesReferenceRegion: play.api.libs.json.Writes[Region] = {
      (obj: io.flow.reference.v0.models.Region) => {
        io.flow.reference.v0.models.json.jsObjectRegion(obj)
      }
    }

    implicit def jsonReadsReferenceTimezone: play.api.libs.json.Reads[io.flow.reference.v0.models.Timezone] = {
      for {
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesReferenceTimezone: play.api.libs.json.Writes[Timezone] = {
      (obj: io.flow.reference.v0.models.Timezone) => {
        io.flow.reference.v0.models.json.jsObjectTimezone(obj)
      }
    }
  }
}
...
package io.flow.reference.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/reference/latest/play_2_8_client"
    val Version = "0.18.69"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.reference.v0.Client")

    logger.info(s"Initializing io.flow.reference.v0.Client for url $baseUrl")

    def carriers: Carriers = Carriers

    def carrierServices: CarrierServices = CarrierServices
    ...
    object Carriers extends Carriers {
      override def get(
        q: _root_.scala.Option[String] = None,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[io.flow.reference.v0.models.Carrier]] = {
        val queryParameters = Seq(
          q.map("q" -> _)
        ).flatten

        _executeRequest("GET", s"/reference/carriers", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.reference.v0.Client.parseJson("Seq[io.flow.reference.v0.models.Carrier]", r, _.validate[Seq[io.flow.reference.v0.models.Carrier]])
          case r if r.status == 401 => throw io.flow.reference.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.reference.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
    }

    object CarrierServices extends CarrierServices {
      override def get(
        q: _root_.scala.Option[String] = None,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[io.flow.reference.v0.models.CarrierService]] = {
        val queryParameters = Seq(
          q.map("q" -> _)
        ).flatten

        _executeRequest("GET", s"/reference/carrier/services", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.reference.v0.Client.parseJson("Seq[io.flow.reference.v0.models.CarrierService]", r, _.validate[Seq[io.flow.reference.v0.models.CarrierService]])
          case r if r.status == 401 => throw io.flow.reference.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.reference.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
    ...
    object Locales extends Locales {
      ...
      override def getById(
        ...
        _executeRequest("GET", s"/reference/locales/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw io.flow.reference.v0.errors.UnitResponse(r.status)
          case r if r.status == 404 => throw io.flow.reference.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.reference.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401, 404")
        }
      }
    }
    ...
    object PaymentMethods extends PaymentMethods {
      override def get(
        q: _root_.scala.Option[String] = None,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[io.flow.reference.v0.models.PaymentMethod]] = {
        val queryParameters = Seq(
          q.map("q" -> _)
        ).flatten

        _executeRequest("GET", s"/reference/payment/methods", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.reference.v0.Client.parseJson("Seq[io.flow.reference.v0.models.PaymentMethod]", r, _.validate[Seq[io.flow.reference.v0.models.PaymentMethod]])
          case r if r.status == 401 => throw io.flow.reference.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.reference.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw io.flow.reference.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
  ...
  package interfaces {
    ...
    trait Client {
      def baseUrl: String
      def carriers: io.flow.reference.v0.Carriers
      def carrierServices: io.flow.reference.v0.CarrierServices
      ...
      def paymentMethods: io.flow.reference.v0.PaymentMethods
  ...
  trait Carriers {
     ...
     *
     * @param q Free text search. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait CarrierServices {
     ...
     *
     * @param q Free text search on name. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait Countries {
     ...
     *
     * @param q Free text search for a single matching country. Can be the 2 or 3 character code
     *        or the name of the country. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait Currencies {
     ...
     *
     * @param q Free text search for a single matching currency. Can be the code or the name of
     *        the currency. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait Languages {
     ...
     *
     * @param q Free text search for a single matching language. Can be the code or the name of
  ...
  trait Locales {
     ...
     *
     * @param q Free text search on name for a single matching locale. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait PaymentMethods {
     ...
     *
     * @param q Free text search on name for a single matching payment method. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait Provinces {
     ...
     *
     * @param q Free text search on name for a single matching region. Case insensitive
     * @param countries ISO 3166 3-character country code. See https://api.flow.io/reference/countries
     */
    def get(
      q: _root_.scala.Option[String] = None,
      countries: _root_.scala.Option[Seq[String]] = None,
  ...
  trait Timezones {
     ...
     *
     * @param q Free text search on name for a single matching timezone. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
