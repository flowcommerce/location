 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/reference/latest/play_2_8_client
 */
...
package io.flow.reference.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsReferencePaymentMethodCapability = new play.api.libs.json.Reads[io.flow.reference.v0.models.PaymentMethodCapability] {
    ...
    implicit def jsonWritesReferencePaymentMethodCapability: play.api.libs.json.Writes[PaymentMethodCapability] = {
      new play.api.libs.json.Writes[io.flow.reference.v0.models.PaymentMethodCapability] {
        def writes(obj: io.flow.reference.v0.models.PaymentMethodCapability) = {
    ...
    implicit val jsonReadsReferencePostalType = new play.api.libs.json.Reads[io.flow.reference.v0.models.PostalType] {
    ...
    implicit def jsonWritesReferencePostalType: play.api.libs.json.Writes[PostalType] = {
      new play.api.libs.json.Writes[io.flow.reference.v0.models.PostalType] {
        def writes(obj: io.flow.reference.v0.models.PostalType) = {
...
package io.flow.reference.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/flow/reference/latest/play_2_8_client"
    val Version = "0.10.42"
    val VersionMajor = 0
