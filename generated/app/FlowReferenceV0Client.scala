 ...
 * apibuilder:0.12.38 https://app.apibuilder.io/flow/reference/0.3.30/play_2_4_client
 */
...
package io.flow.reference.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.38 https://app.apibuilder.io/flow/reference/0.3.30/play_2_4_client"
    val Version = "0.3.30"
    val VersionMajor = 0
  ...
  trait Countries {
     ...
     * @param q Free text search for a single matching country. Can be the 2 or 3
     * character code or the name of the country. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait Currencies {
     ...
     * @param q Free text search for a single matching currency. Can be the code or the
     * name of the currency. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait Languages {
     ...
     * @param q Free text search for a single matching language. Can be the code or the
     * name of the language. Case insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
      requestHeaders: Seq[(String, String)] = Nil
  ...
  trait PaymentMethods {
     ...
     * @param q Free text search on name for a single matching payment method. Case
     * insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
  ...
  trait Provinces {
     ...
     * @param countries ISO 3166 3-character country code. See
     * https://api.flow.io/reference/countries
     */
    def get(
      q: _root_.scala.Option[String] = None,
  ...
  trait Timezones {
     ...
     * @param q Free text search on name for a single matching timezone. Case
     * insensitive
     */
    def get(
      q: _root_.scala.Option[String] = None,
