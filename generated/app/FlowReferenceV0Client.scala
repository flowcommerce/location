 ...
 * apibuilder 0.14.93 app.apibuilder.io/flow/reference/latest/play_2_8_client
 */
...
package io.flow.reference.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/reference/latest/play_2_8_client"
    val Version = "0.7.58"
    val VersionMajor = 0
