 ...
 * apibuilder:0.12.3 https://api.apibuilder.io/flow/reference/0.3.30/play_2_4_client
 */
...
package io.flow.reference.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.3 https://api.apibuilder.io/flow/reference/0.3.30/play_2_4_client"
    val Version = "0.3.30"
    val VersionMajor = 0
