 ...
 * apidoc:0.11.23 http://www.apidoc.me/flow/common/0.0.12/play_2_4_client
 */
package io.flow.common.v0.models {
  ...
  case class Schedule(
    ...
    holidays: _root_.scala.Option[Seq[io.flow.common.v0.models.Holiday]] = None,
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsCommonHoliday: play.api.libs.json.Reads[Holiday] = {
      (
    ...
    def jsObjectHoliday(obj: io.flow.common.v0.models.Holiday) = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesCommonHoliday: play.api.libs.json.Writes[Holiday] = {
      new play.api.libs.json.Writes[io.flow.common.v0.models.Holiday] {
        def writes(obj: io.flow.common.v0.models.Holiday) = {
          jsObjectHoliday(obj)
        }
      }
    }
    ...
    implicit def jsonReadsCommonSchedule: play.api.libs.json.Reads[Schedule] = {
      (
        ...
        (__ \ "holidays").readNullable[Seq[io.flow.common.v0.models.Holiday]] and
    ...
    def jsObjectSchedule(obj: io.flow.common.v0.models.Schedule) = {
      ...
      (obj.holidays match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("holidays" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.cutoff match {
        case None => play.api.libs.json.Json.obj()
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.23 http://www.apidoc.me/flow/common/0.0.12/play_2_4_client"
    val Version = "0.0.12"
    val VersionMajor = 0
